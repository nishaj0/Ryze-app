...
## Summary
- 11297 nodes · 11241 edges · 922 communities (916 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ac99faea`
...
- `AuthStack()` --calls--> `useTheme()`  [EXTRACTED]
  expo-app/src/navigation/AuthStack.tsx → expo-app/src/theme/themeStore.ts
...
- `StatCard()` --calls--> `useTheme()`  [EXTRACTED]
  expo-app/src/screens/progress/DashboardScreen.tsx → expo-app/src/theme/themeStore.ts
- `RecordsScreen()` --calls--> `useTheme()`  [EXTRACTED]
  expo-app/src/screens/progress/RecordsScreen.tsx → expo-app/src/theme/themeStore.ts

## Import Cycles
- None detected.

## Communities (922 total, 6 thin omitted)
...
Cohesion: 0.08
Nodes (47): Button(), ButtonProps, Size, Variant, Card(), CardProps, ExerciseImageCarousel(), ExerciseImageCarouselProps (+39 more)
...
## Knowledge Gaps
- **9952 isolated node(s):** `Stack`, `Stack`, `Props`, `{ width: screenW }`, `StatCardProps` (+9947 more)
...
- **Why does `dependencies` connect `Backend Controllers Core` to `Middleware & Route Setup`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **Why does `useTheme()` connect `Expo App Dependencies` to `Frontend API Client`, `Auth & Splits Routes`, `API Server Dependencies`, `Community 39`, `Community 23`, `Community 29`, `Community 30`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **What connects `Stack`, `Stack`, `Props` to the rest of the system?**
  _9952 weakly-connected nodes found - possible documentation gaps or missing edges._
