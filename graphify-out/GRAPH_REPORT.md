...
## Summary
- 11533 nodes · 11649 edges · 939 communities (932 shown, 7 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `eb1f6683`
...
- `AuthGuard()` --calls--> `getAdminKey()`  [INFERRED]
  cpanel/src/App.tsx → cpanel/src/api.ts
- `SupportTicketsPage()` --calls--> `useToast()`  [EXTRACTED]
  cpanel/src/pages/SupportTicketsPage.tsx → cpanel/src/components/Toast.tsx
...
Cohesion: 0.07
Nodes (42): completeOnboarding(), getRecommendedSplits(), OnboardingStack(), Stack, MainTabParamList, OnboardingStackParamList, ScreenProps, WorkoutStackParamList (+34 more)
...
Cohesion: 0.33
Nodes (5): App(), App(), cache, initMMKV(), mmkv

### Community 4 - "API Server Dependencies"
Cohesion: 0.05
Nodes (60): getExerciseProgress(), getHeatmap(), getMuscleVolume(), getOverview(), getVolumeHistory(), getRecords(), addExercise(), completeSession() (+52 more)
...
Cohesion: 0.18
Nodes (5): prisma, sendPushNotification(), triggerReminders(), prisma, AuthRequest
...
Cohesion: 0.05
Nodes (49): AppSettings, getAppSettings(), listExercises(), requestExercise(), createSplit(), getActiveSplit(), getSplit(), listSplits() (+41 more)

### Community 31 - "Community 31"
Cohesion: 0.11
Nodes (15): AvatarProps, Badge(), badgeColors, BadgeProps, ConfirmDialog(), ConfirmProps, PageLoader(), Pagination() (+7 more)
...
Cohesion: 0.07
Nodes (36): BarChart(), BarChartProps, BarItem, Heatmap(), HeatmapDay, HeatmapProps, ChartPoint, LineChart() (+28 more)
...
Cohesion: 0.13
Nodes (28): ExerciseMetaBadges(), ExerciseMetaBadgesProps, styles, Icon(), IconName, IconProps, Screen(), ScreenProps (+20 more)
...
Cohesion: 0.13
Nodes (11): Toast, ToastContext, ToastCtx, ToastProvider(), SettingsPage(), getAdminKey(), getAppSettings(), updateAppSettings() (+3 more)

### Community 933 - "Community 933"
Cohesion: 0.28
Nodes (7): useToast(), LoginPage(), NotificationsPage(), SplitsPage(), UsersPage(), getDashboard(), sendBroadcast()

### Community 934 - "Community 934"
Cohesion: 0.15
Nodes (9): nav, EditForm, User, api, deleteUser(), getUsers(), resetOnboarding(), setAdminKey() (+1 more)

### Community 935 - "Community 935"
Cohesion: 0.18
Nodes (6): Avatar(), DashData, SupportTicketsPage(), Ticket, getSupportTickets(), respondToSupportTicket()
...
## Knowledge Gaps
- **10054 isolated node(s):** `prisma`, `app`, `router`, `router`, `router` (+10049 more)
...
- **Why does `useTheme()` connect `Community 924` to `Frontend API Client`, `Auth & Splits Routes`, `Community 928`, `Expo App Dependencies`, `API Server Dependencies`, `Community 932`, `Community 39`, `Community 938`, `Community 29`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `setActiveSplit()` connect `Community 29` to `Community 908`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **Why does `AuthRequest` connect `Progress Analytics Controller` to `Middleware & Route Setup`, `Photos Feature`, `Community 939`, `Community 908`, `Skills Lock Registry`, `Auth Controller`, `Photo Controller & Cloudinary`, `Database Seed Data`, `Expo TypeScript Config`?**
  _High betweenness centrality (0.000) - this node is a cross-community bridge._
- **What connects `prisma`, `app`, `router` to the rest of the system?**
  _10054 weakly-connected nodes found - possible documentation gaps or missing edges._
