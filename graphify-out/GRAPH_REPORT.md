...
## Corpus Check
- 1083 files · ~3,599,242 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 11697 nodes · 12018 edges · 947 communities (939 shown, 8 thin omitted)
...
## Communities (947 total, 8 thin omitted)
...
Cohesion: 0.06
Nodes (23): authMiddleware(), validate(), loginSchema, registerSchema, router, checkInSchema, router, prisma (+15 more)
...
- **Why does `setActiveSplit()` connect `Community 928` to `Auth & Splits Routes`, `Community 939`?**
