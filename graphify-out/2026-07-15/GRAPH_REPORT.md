...
## Corpus Check
- 1107 files · ~3,613,994 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 11841 nodes · 12307 edges · 960 communities (950 shown, 10 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e3bb1275`
...
- `InstructionStepper()` --calls--> `useTheme()`  [EXTRACTED]
  expo-app/src/components/InstructionStepper.tsx → expo-app/src/theme/themeStore.ts
...
## Communities (960 total, 10 thin omitted)
...
Cohesion: 0.06
Nodes (55): completeOnboarding(), getRecommendedSplits(), generateAISplit(), LoginScreen(), Props, Props, RegisterScreen(), MetricsScreen() (+47 more)
...
Cohesion: 0.06
Nodes (45): addExercise(), completeSession(), createSession(), deleteSet(), getCalendarSessions(), logSet(), markRestDay(), swapExercise() (+37 more)
...
Cohesion: 0.09
Nodes (24): CheckIn, createCheckIn(), getCheckIn(), updateCheckIn(), getSession(), HomeStack(), HomeStackNav, MainTabs() (+16 more)
...
Cohesion: 0.07
Nodes (23): deleteAccount(), login(), register(), updateProfile(), client, EditProfileScreen(), equipmentOptions, experienceLevels (+15 more)
...
Cohesion: 0.12
Nodes (14): AvatarProps, Badge(), badgeColors, BadgeProps, ConfirmDialog(), ConfirmProps, PageLoader(), Pagination() (+6 more)
...
Cohesion: 0.08
Nodes (40): getMyTickets(), submitSupportTicket(), SupportTicket, Card(), Icon(), IconName, IconProps, DashboardScreenSkeleton() (+32 more)
...
Cohesion: 0.19
Nodes (8): nav, SettingsPage(), getAdminKey(), getAppSettings(), setAdminKey(), AuthGuard(), PAGE_TITLES, ProtectedLayout()
...
Cohesion: 0.13
Nodes (12): Exercise, DayForm, MUSCLE_GROUPS, Split, api, createSplit(), deleteSplit(), getExerciseFilters() (+4 more)
...
Cohesion: 0.33
Nodes (3): log, sendPushNotification(), triggerReminders()
...
Cohesion: 0.07
Nodes (39): deletePhoto(), getPhotos(), uploadPhoto(), Button(), ButtonProps, Size, Variant, CardProps (+31 more)
...
## Knowledge Gaps
- **10201 isolated node(s):** `IconProps`, `InstructionStepperProps`, `styles`, `Tab`, `HomeStackNav` (+10196 more)
...
- **Why does `useTheme()` connect `Community 924` to `Community 928`, `Auth & Splits Routes`, `Frontend API Client`, `API Server Dependencies`, `Community 39`, `Community 9`, `Photos Feature`, `Community 15`, `Community 949`, `Community 952`, `Community 959`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **Why does `dependencies` connect `Backend Controllers Core` to `Community 939`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **What connects `IconProps`, `InstructionStepperProps`, `styles` to the rest of the system?**
  _10201 weakly-connected nodes found - possible documentation gaps or missing edges._
